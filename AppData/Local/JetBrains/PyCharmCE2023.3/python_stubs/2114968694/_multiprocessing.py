...
# from C:\Users\kotha\AppData\Local\Programs\Python\Python312\DLLs\_multiprocessing.pyd
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C5A5D48C20>'

__spec__ = None # (!) real value is "ModuleSpec(name='_multiprocessing', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C5A5D48C20>, origin='C:\\\\Users\\\\kotha\\\\AppData\\\\Local\\\\Programs\\\\Python\\\\Python312\\\\DLLs\\\\_multiprocessing.pyd')"
